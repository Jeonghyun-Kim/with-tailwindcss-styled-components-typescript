          ...
          >
            <button
              ...
              className={cn(
                ...
                {
                  'bg-indigo-600 hover:bg-indigo-700 focus:ring-indigo-500 sm:col-start-2':
                    variant === 'default',
                  'bg-red-600 hover:bg-red-700 focus:ring-red-500 sm:ml-3 sm:w-auto':
                    variant === 'alert',
                },
              )}
              onClick={() => {
            ...
            {cancelButton && (
              <button
                type="button"
                className={cn(
                  'mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:text-sm',
                  {
